    ...
    <div class="dashboard-layout">
        ...
        <div class="dashboard-content">
            ...
            <div class="dashboard-top-summary-row">
                ...
                {{-- Manage Requests Summary --}}
                <div class="employee-list-panel manage-request-summary-panel mb-3">
                    <div class="employee-list-panel-header">
                        <div class="employee-list-panel-title">
                            <div>
                    ...
                    <div class="employee-list-panel-body">
                        <div class="manage-request-summary-card {{ $pendingRequestsFromOthersCount > 0 ? 'manage-request-alert' : '' }}">

                            <div class="manage-request-summary-main">
                                {{ $pendingRequestsFromOthersCount }}
                            </div>

                            <div class="manage-request-summary-title">
                                Pending request(s) from staff
                            </div>

                            <div class="manage-request-summary-detail">
                                Leave: {{ $pendingLeaveFromOthersCount }}
                                |
                                Shift Swap: {{ $pendingShiftSwapFromOthersCount }}
                            </div>

                            <div class="manage-request-summary-action">
                                <a href="{{ route('managerequest') }}" class="btn btn-primary btn-sm">
                                    <i class="fa fa-eye"></i>
                                    Review Requests
                                </a>
                            </div>
                ...
                <div class="employee-list-panel dashboard-quick-action-panel mb-3">
                    ...
                    <div class="employee-list-panel-body">
                        <div class="dashboard-quick-action-card">
                            <a href="{{ route('setting') }}" class="dashboard-quick-action-link">
                                <i class="fa fa-gear"></i>
                                <span>Settings</span>
                            </a>
                            <a href="{{ route('generateroster') }}" class="dashboard-quick-action-link">
                                <i class="fa fa-calendar-plus-o"></i>
                                <span>Generate Roster</span>
                            </a>
                            <a href="{{ route('employeedetails') }}" class="dashboard-quick-action-link">
